                ...
                <Stack mt={"20px"} direction={'row'} justify={'space-between'}>
                    <Stack w={'70%'}>
                        ...
                        <Stack direction={'row'} w={'full'} justify={'space-between'} mb={'25px !important'}>
                            <Stack direction={'row'}>
                                ...
                                <Box>
                                    ...
                                    <Text color={'#fff'} fontSize={'18px'}>{location?.state?.username ?? 'Eva jackson'}</Text>
                                </Box>
                            </Stack>
                            <Box>
                                <Text color={'#fff'} fontSize={'18px'} opacity={'0.5'}>Email</Text>
                                <Text color={'#fff'} fontSize={'18px'}>{location?.state?.email ?? 'evajackson43@gmail.com'}</Text>
                            </Box>
                            <Box>
                                <Text color={'#fff'} fontSize={'18px'} opacity={'0.5'}>DOB</Text>
                                <Text color={'#fff'} fontSize={'18px'}>{String(location?.state?.dateofbirth).split('T')[0] ?? '06/25/1999'}</Text>
                            </Box>
                            <Box></Box>
                        </Stack>
                        ...
                        <Box w={'100%'} p={'0px 10px'} mb={'20px'}>
                            ...
                            <Text color={'#fff'} mt={'10px'}>12 Drinks</Text>
                        </Box>
